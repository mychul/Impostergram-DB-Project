    ...
    def uploads(self):
        try: 
            ...
            if(myFile.is_file()):
                ...
                count = count + 1
                pid = "p" + str(count)
                self.cur.execute("INSERT INTO Photos (photo_id, publisher, dates, privacy, description, numLikes) VALUES (%s, %s, %s, %s, %s, %s)", (pid, self.username, now, str(0), description, str(numLikes)))
